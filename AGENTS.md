...
- [docs/05-events-page.md](docs/05-events-page.md) - the public events page, the Monday
...
Per the global AGENTS.md: write the code directly in the main session, no subagents,
